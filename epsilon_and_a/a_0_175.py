...
ax.text(0, 1, r'(a2)', transform=ax.transAxes, fontsize=34,
        va='top', ha='left', fontweight='bold')
ax.text(0.25, 0.96, r'$\boldsymbol{a=0.175}$', transform=ax.transAxes,
        fontsize=30, va='top',
...
ax.text(0.77, 1.0, r'(b2)', transform=ax.transAxes, fontsize=32,
        va='top', ha='left', fontweight='bold')
plt.tight_layout()
plt.savefig('Phase_Portrait_a_2.eps', format='eps',dpi = 300, bbox_inches='tight')
plt.show()
