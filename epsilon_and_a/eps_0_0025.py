...
ax.text(0, 1, r'(b1)', transform=ax.transAxes, fontsize=32,
        va='top', ha='left', fontweight='bold')
ax.text(0.25, 0.96, r'$\boldsymbol{\varepsilon=0.0025}$', transform=ax.transAxes,
        fontsize=22, va='top',
...
ax.text(0.77, 1.0, r'(b2)', transform=ax.transAxes, fontsize=34,
        va='top', ha='left', fontweight='bold')
plt.tight_layout()
plt.savefig('Phase_Portrait_ε_2.eps', format='eps', dpi=300, bbox_inches='tight')
plt.show()
